 ...
 */
export const Chip = ({ className, label, active = false, background = 'default', ...props }: ChipProps) => {
  ...
  const styles = {
    container: cn(
      ...
      isInverse
        ? 'bg-gray-95 text-common-0 border border-gray-95'
        : 'border border-gray-50 text-common-100 bg-common-0',
      className
    ),
    label: cn('text-body3Normal whitespace-nowrap'),
  };

  return (
    <div role="button" className={styles.container} {...props}>
